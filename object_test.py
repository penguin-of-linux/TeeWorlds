...
class ObjectTest(unittest.TestCase):
    ...
    def test_crossing(self):
        ...
        self.assertEquals(ob2.is_crossing(object.Object((0, 0), (0, 0))), True)
        self.assertEquals(ob2.is_crossing(object.Object((-5, 5), (10, 10))), True)
        self.assertEquals(ob2.is_crossing(object.Object((-5, 5), (3, 3))), False)
        self.assertEquals(ob2.is_crossing(object.Object((-5, 5), (5, 5))), True)
        self.assertEquals(ob2.is_crossing(object.Object((-100, 100), (1000, 1000))), False)
        self.assertEquals(ob2.is_crossing(object.Object((-500, 0), (3, 3))), False)
        self.assertEquals(ob2.is_crossing(object.Object((1, -1), (3, 3))), True)
